...
public class QuestionAssignmentEndpoint {
	...
	public QuestionAssignmentEndpoint(QuestionRepository questionRepository,
			...
			AssignmentRepository assignmentRepository, GenericService service, CascadeDeleteService deleteService,
	...
	private void validateQuestionAndAssignmentExistence(@Valid @RequestBody QuestionAssignment questionAssignment) {
		service.throwResourceNotFoundIfDoesNotExist(questionAssignment.getQuestion(), questionRepository,
				"Question not found");
		service.throwResourceNotFoundIfDoesNotExist(questionAssignment.getAssignment(), assignmentRepository,
	...
	private boolean isQuestionAlreadyAssociatedWithAssignment(QuestionAssignment questionAssignment) {
		...
		List<QuestionAssignment> questionAssignments = questionAssignmentRepository
				.listQuestionAssignmentByQuestionAndAssignment(questionId, assignmentId);
	...
	private void validateQuestionAssignmentOnDB(Long questionAssignmentId) {
		service.throwResourceNotFoundIfDoesNotExist(questionAssignmentId, questionAssignmentRepository,
				"QuestionAssignment not found");
